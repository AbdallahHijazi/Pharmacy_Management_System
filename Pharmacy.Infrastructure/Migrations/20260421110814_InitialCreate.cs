...
namespace Pharmacy.Infrastructure.Migrations
{
    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SalesInvoiceItems_StockBatches_StockBatchId",
                        column: x => x.StockBatchId,
                        principalTable: "StockBatches",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SalesReturnItems_StockBatches_StockBatchId",
                        column: x => x.StockBatchId,
                        principalTable: "StockBatches",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Products_Barcode_IsDeleted",
                table: "Products",
                columns: new[] { "Barcode", "IsDeleted" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PurchaseInvoiceItems_BatchNumber",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SalesInvoiceItems_StockBatchId",
                table: "SalesInvoiceItems",
                column: "StockBatchId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SalesReturnItems_StockBatchId",
                table: "SalesReturnItems",
                column: "StockBatchId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StockBatches_ProductId_BatchNumber",
                table: "StockBatches",
                columns: new[] { "ProductId", "BatchNumber" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_StockBatches_ProductId_ExpiryDate",
                table: "StockBatches",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SystemSettings_Key_IsDeleted",
