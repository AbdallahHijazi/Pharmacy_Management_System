...
internal static class PurItemColumnLayout
{
    ...
    public static CreatePurchaseInvoiceLineControl.ColumnLayout GetColumnRects(Rectangle bounds, int? tableWidth = null)
    {
        var width = Math.Max(tableWidth ?? bounds.Width, MinTableWidth);
        var pad = EdgePad;
        var gap = CellGap;
...
internal sealed class PurInputHost : Panel
{
    ...
    protected override void OnPaint(PaintEventArgs e)
    {
        ...
        RoundedDrawing.DrawRoundedBorder(
            ...
            r,
            10,
            _focused ? PharmaTheme.Primary : PharmaTheme.Border,
            _focused ? 1.75f : 1f);
    }
