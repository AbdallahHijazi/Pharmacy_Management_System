...
namespace Pharmacy.WinForms
{
    ...
    public sealed class AmbientFormSurface : Panel
    {
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            using var bg = new LinearGradientBrush(ClientRectangle, Color.FromArgb(249, 252, 250), Color.FromArgb(235, 245, 240), 0F);
    ...
    public sealed class DnaPanel : Panel
    {
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            using var bg = new LinearGradientBrush(ClientRectangle, Color.FromArgb(2, 48, 34), Color.FromArgb(0, 88, 58), 35F);
            e.Graphics.FillRectangle(bg, ClientRectangle);
    ...
    public sealed class RoundedTextInput : UserControl
    {
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            using var border = new Pen(focused ? Color.FromArgb(12, 119, 78) : Color.FromArgb(214, 226, 220), focused ? 1.8F : 1F);
