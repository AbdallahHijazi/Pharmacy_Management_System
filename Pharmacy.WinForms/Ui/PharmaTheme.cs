...

{
    ...
    public const int UsersStatCornerRadius = 22;
    public const int UsersSearchCornerRadius = 14;
    public const int UsersRowHeight = 80;
    public const int UsersRowCornerRadius = 14;
    public const int UsersDetailsWidth = 380;
